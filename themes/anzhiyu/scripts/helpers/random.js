hexo.extend.generator.register("random", function (locals) {
  ...
  let result = `var posts=${JSON.stringify(
    ...
    ${pjaxEn ? `pjax.loadUrl('${hexo.config.root}'+posts[Math.floor(Math.random() * posts.length)]);` : `window.location.href='${hexo.config.root}'+posts[Math.floor(Math.random() * posts.length)];`}
  };`;
